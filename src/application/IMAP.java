...
public class IMAP {
	...
	private static List<String> Ausgabearray_nachricht = new ArrayList<String>();
...
public void start(String Server, String Mail, String Passwort){
	...
	Ausgabearray_nachricht.add("Nachrichtid:" + Zahl);
	Zahl--;
	}
}
...
public List<String> getAusgabearray_inhalt() {
	// TODO Auto-generated method stub
	return Ausgabearray_nachricht;
}
}
